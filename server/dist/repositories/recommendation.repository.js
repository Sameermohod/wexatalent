...
class RecommendationRepository extends base_repository_1.BaseRepository {
    ...
    async recommendByMutuals(devId, limit = 5) {
        const query = `
    ...
    async findShortestPath(devId1, devId2) {
        const query = `
    ...
    async suggestMentors(devId, limit = 5) {
        const query = `
    ...
    async recommendJobs(devId, limit = 5) {
        const query = `
    ...
    async recommendProjects(devId, limit = 5) {
        const query = `
    ...
    async recommendCommunities(communityId, limit = 5) {
        const query = `
    ...
    async multiHopJobTraversal(devId, limit = 5) {
        const query = `
    ...
    async getComplexRecommendations(devId, limit = 5) {
        const query = `
