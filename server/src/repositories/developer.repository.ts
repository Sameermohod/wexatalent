...
export class DeveloperRepository extends BaseRepository {
  ...
  async findById(id: string, currentUserId?: string) {
    ...
    return {
      ...devProps,
      skills: record.get('skills').filter((s: any) => s.id !== null),
      technologies: record.get('technologies').filter((t: any) => t.id !== null),
      experience: record.get('experience').filter((e: any) => e.id !== null),
      contributions: record.get('contributions').filter((c: any) => c.id !== null),
      communities: record.get('communities').filter((co: any) => co.id !== null),
